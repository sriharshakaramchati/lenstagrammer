...
def index():
    ...
    <body>
        <div class="container">
            <div class="text-side">
		<h2>Lenstagrammer</h2>
                <p>Port your fandom to web3. Prove that you have more than 10K followers on Instagram to become a star on Lens</p>
		<button>Claim Lens Handle</button>
            </div>
            <div class="qr-side">
                <img src="{{ url_for('static', filename='qr_code.png') }}" alt="QR Code" width="150">
            </div>
        </div>
    </body>
    </html>
